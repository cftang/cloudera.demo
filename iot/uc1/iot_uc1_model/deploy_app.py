...
DEFAULT_APP_SCRIPT = f"{PROJECT_ROOT}/iot_uc1_model/run_app.py"
RUNTIME_IMAGE = (
...
def main() -> None:
    ...
    try:
        ...
        print('       -d \'{"health_score":38.5,"vibration_rms_x":1.0617,')
        print('             "vibration_rms_y":1.0927,"vibration_rms_z":3.6932,"anomaly_score":1.0}\'')
