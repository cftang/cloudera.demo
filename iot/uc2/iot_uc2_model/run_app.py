...
Upload this directory to /home/cdsw/iot_uc2_model/ in your CML project.
The CAI Application startup script should be: iot_uc2_model/run_app.py
...
DEFAULT_APP_DIR = f"{PROJECT_ROOT}/iot_uc2_model"
